...
export class VerDiagComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.Municipio) {
      const municipioData = this.municipios.find(
        (m) => m.Municipio === this.Municipio
      );
      if (municipioData) {
        this.actores =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/' +
          this.direcciones.archivos.actores;
        this.apoyoProy =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/' +
          this.direcciones.archivos.apoyos;
        this.preparacion =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/' +
          this.direcciones.archivos.preparacion;
        this.leccionesAprendidas =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/' +
          this.direcciones.archivos.lecciones_aprendidas;
        this.recoleccionInsMif =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/recoleccionInfo/' +
          this.direcciones.archivos.recoleccion_info.mif_institucional;
        this.recoleccionLocMif =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/recoleccionInfo/' +
          this.direcciones.archivos.recoleccion_info.mif_locales;
        this.recoleccionInsRed =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/recoleccionInfo/' +
          this.direcciones.archivos.recoleccion_info.reduccion_institucional;
        this.recoleccionLocRed =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/recoleccionInfo/' +
          this.direcciones.archivos.recoleccion_info.reduccion_locales;
        this.recoleccionInsAtn =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/recoleccionInfo/' +
          this.direcciones.archivos.recoleccion_info.atencion_institucional;
        this.recoleccionLocAtn =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/recoleccionInfo/' +
          this.direcciones.archivos.recoleccion_info.atencion_locales;
        this.recoleccionInsPro =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/recoleccionInfo/' +
          this.direcciones.archivos.recoleccion_info.promocion_institucional;
        this.recoleccionLocPro =
          this.direcciones.direccion_base +
          municipioData.Municipio +
          '/recoleccionInfo/' +
          this.direcciones.archivos.recoleccion_info.promocion_locales;
      } else {
        console.warn(
          `Municipio "${this.Municipio}" no encontrado en la lista.`
        );
      }
    }
  }
