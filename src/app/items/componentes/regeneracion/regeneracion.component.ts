...
export class RegeneracionComponent {
  ...
  data = [
    {
      ...
      "leyenda": [
        ...
        { "texto": "Limite Municipal", "img": "assets/iconosLeyenda/ap2.png" },
        { "texto": "Comunidades", "img": "assets/iconosLeyenda/pcp.png" },
    ...
    },
    {
      ...
      "leyenda": [
        ...
        { "texto": "Regeneración vegetal pasiva positiva", "img": "assets/iconosLeyenda/b2.png" },
      ]
    },
    {
      "municipio": "Tiquipaya",
  ...
  activa = [
    {
      ...
      "leyenda": [
        ...
        { "texto": "Regeneración vegetal pasiva ", "img": "assets/iconosLeyenda/b2.png" },
      ]
    },
    {
      "municipio": "San Buenaventura",
  ...
  Datosactiva = [
    {
      "municipio": "Palos Blancos",
      "leyenda": "Implementación de plantines de cacao criollo con enfoque  agroforestal y mejoramiento de la genética del material vegetal mediante la implementación de varetas",
      "area": "28 ha",

    },
    {
      "municipio": "San Buenaventura",
      "leyenda": "Implementación de plantines de cacao criollo con enfoque agroforestal.",
      "area": "11,5 ha",
    },
    {
      "municipio": "Tiquipaya",
      "leyenda": "Producción de plantines forestales nativos para establecimiento de plantaciones en zonas priorizadas con fines de apoyo a la recuperación",
      "area": "20 ha",
    },
    {
      "municipio": "Vinto",
      "leyenda": "Producción de plantines forestales nativos para establecimiento de plantaciones en zonas priorizadas.",
      "area": "20 ha",
    },
    {
      "municipio": "San Borja",
  ...
  buscarMunicipio(nombreMunicipio: string, opcion: string) {
    ...
    if (opcion == 'pasiva') {
      ...
      this.municipioData = this.activa.find(item => item.municipio === nombreMunicipio);
      this.datosactivo=this.Datosactiva.find(item=>item.municipio===nombreMunicipio)
    }
  }
