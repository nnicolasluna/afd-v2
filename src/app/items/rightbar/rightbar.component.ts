...
export class RightbarComponent {
  ...
  ciudades = [
    ...
    { departamento: 'Beni', provincia: 'Sur Yungas', AreaProt: 'RBTCO Pilon Lajas', publoIndigena: 'Moseten', municipio: 'Rurrenabaque', png: 'assets/IconosMunicipios/San Borja.png', color: '#8FCE00', latMun: -14.442222, lonMun: -67.528333 },
